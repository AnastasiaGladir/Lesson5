package ru.mirea.gladirap.audiorecord;
...
import ru.mirea.gladirap.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordButton = binding.battonRecord;
        playButton = binding.battonPlay;
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStartRecording) {
                    recordButton.setText("Start play");
                    playButton.setEnabled(false);
                    startRecording();
                } else {
                    recordButton.setText("Stop play");
